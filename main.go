...
func main() {
	...
	//helpFlag := flag.String("h", "", "help, and description of flags")
	...
	//fmt.Println(config.Mailserver.FromMail, config.Mailserver.SMTPGate, config.Mailserver.SMTPPort, config.Authentication.Login)
